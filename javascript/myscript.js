...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Muốn biết lí do thì bấm vào -> Nhịp tim của em đập siu nhanh " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Nhịp tim nhanh như thế là do:';
document.querySelector('.Description .modal-body').innerHTML = 'Em thích chị đóoo <i class="fas fa-heart"></i> ';
